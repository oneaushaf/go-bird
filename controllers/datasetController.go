...
// 		return
// 	}
// 	if dataset.IsTrained {
// 		c.JSON(http.StatusBadRequest, gin.H{
// 			"message": "dataset has already trained",
// 		})
// 		return
// 	}
// 	species, err := repositories.GetSpeciesById(strconv.Itoa(int(dataset.SpeciesID)))
...
// 	err1 := services.DeleteImagesInRange(storage+"/train/"+folder, starts[0], ends[0])
// 	err2 := services.DeleteImagesInRange(storage+"/validation/"+folder, starts[1], ends[1])
// 	err3 := services.DeleteImagesInRange(storage+"/test/"+folder, starts[2], ends[2])
...
// 	species.Training -= trainCount
// 	species.Untrained -= trainCount
// 	species.Testing -= sideCount
// 	species.Validation -= sideCount

// 	err = repositories.DB.Save(&species).Error
// 	if err != nil {
// 		c.JSON(http.StatusInternalServerError, gin.H{
...
// 		return
// 	}
// 	err = repositories.DB.Delete(&dataset).Error
// 	if err != nil {
// 		c.JSON(http.StatusInternalServerError, gin.H{
